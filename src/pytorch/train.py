...
def train(
    ...
    # create the model
    model = modules.FBNet(input_shape=(batch_size, 3, height, width), device=device).to(
        device
    )
    ...
    plot_5_path = os.path.join(target_path, "plot_5.png")
    plot_5_loss_path = os.path.join(target_path, "plot_5_loss.png")
    plot_5_raw_loss_path = os.path.join(target_path, "plot_5_raw_loss.png")
    plot_50_path = os.path.join(target_path, "plot_50.png")
    plot_50_loss_path = os.path.join(target_path, "plot_50_loss.png")
    plot_50_raw_loss_path = os.path.join(target_path, "plot_50_raw_loss.png")
    utils.save_history_plot(plot_5_path, history, exclude=None, use_norm=True, steps=5)
    utils.save_history_plot(
        plot_5_loss_path,
        history,
        exclude=["psnr", "mse", "mae", "ssim"],
        use_norm=True,
        steps=5,
    )
    utils.save_history_plot(
        plot_5_raw_loss_path,
        history,
        exclude=["psnr", "mse", "mae", "ssim"],
        use_norm=False,
        steps=5,
    ...
    utils.save_history_plot(
        plot_50_path, history, exclude=None, use_norm=True, steps=50
    )
    utils.save_history_plot(
        plot_50_loss_path,
        history,
