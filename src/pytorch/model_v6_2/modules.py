...
class FBNet(nn.Module):
    ...
    def forward(self, left, right):
        ...
        warp_r4, flow_r4 = self.flow_warp_r4(
            input_right_cnn_r4_1, input_left_cnn_r4_1, None
        )
        warp_r3, flow_r3 = self.flow_warp_r3(
            input_right_cnn_r3_1, input_left_cnn_r3_1, flow_r4
        )
        warp_r2, flow_r2 = self.flow_warp_r2(
            input_right_cnn_r2_1, input_left_cnn_r2_1, flow_r3
        )
        warp_r1, flow_r1 = self.flow_warp_r1(
            input_right_cnn_r1_1, input_left_cnn_r1_1, flow_r2
        )
