...
class FlowFeatureWarp(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.cnn_1 = Conv2dBlock(
            input_channels, fcounts[0], fsizes[0], 1, fpads[0], "replicate"
        )
        self.cnn_2 = Conv2dBlock(
            input_channels + fcounts[0], fcounts[1], fsizes[1], 1, fpads[1], "replicate"
        )
        self.cnn_3 = Conv2dBlock(
...
class FBNet(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.resize_1_2 = torchvision.transforms.Resize(
            size=(self.h // 2, self.w // 2), antialias=True
        )
        self.resize_1_4 = torchvision.transforms.Resize(
            size=(self.h // 4, self.w // 4), antialias=True
        )
        self.resize_1_8 = torchvision.transforms.Resize(
            size=(self.h // 8, self.w // 8), antialias=True
        )
        ...
        self.cnn_r2_c2 = Conv2dBlock(
            encoder_filters[0][0], encoder_filters[1][0], 3, 1, 1
        )
        self.cnn_r3_c2 = Conv2dBlock(
            encoder_filters[0][1], encoder_filters[1][1], 3, 1, 1
        )
        self.cnn_r4_c2 = Conv2dBlock(
            encoder_filters[0][2], encoder_filters[1][2], 3, 1, 1
        )

        self.cnn_r3_c3 = Conv2dBlock(
            encoder_filters[1][0], encoder_filters[2][0], 3, 1, 1
        )
        self.cnn_r4_c3 = Conv2dBlock(
            encoder_filters[1][1], encoder_filters[2][1], 3, 1, 1
        )
        ...
        self.flow_warp_r1 = FlowFeatureWarp(
            input_channels=encoder_filters[0][0], level=1
        )
        self.flow_warp_r2 = FlowFeatureWarp(
            input_channels=encoder_filters[0][1] + encoder_filters[1][0], level=2
        )
        self.flow_warp_r3 = FlowFeatureWarp(
            input_channels=encoder_filters[0][2]
            + encoder_filters[1][1]
            + encoder_filters[2][0],
            level=3,
        )
        self.flow_warp_r4 = FlowFeatureWarp(
            input_channels=encoder_filters[0][3]
            + encoder_filters[1][2]
            + encoder_filters[2][1],
            level=4,
        )
        ...
        self.attention_r1 = AttentionGate(
            g_filters=4, x_filters=encoder_filters[0][0], filters=4
        )
        ...
        self.cnn_r4 = Conv2dBlock(
            encoder_filters[0][3] + encoder_filters[1][2] + encoder_filters[2][1],
            encoder_filters[0][2] + encoder_filters[1][1] + encoder_filters[2][0],
            3,
            1,
            1,
        )
        ...
        self.cnn_r3 = Conv2dBlock(
            encoder_filters[0][2] + encoder_filters[1][1] + encoder_filters[2][0],
            encoder_filters[0][1] + encoder_filters[1][0],
            3,
            1,
            1,
        )
    ...
    def forward(self, input_1_left, input_1_right):
        ...
        # Concatenate
        concat_left_row_2 = torch.cat(
            [input_2_left_cnn_r2_c1, input_1_left_cnn_r2_c2], dim=1
        )
        concat_left_row_3 = torch.cat(
            [input_3_left_cnn_r3_c1, input_2_left_cnn_r3_c2, input_1_left_cnn_r3_c3],
            dim=1,
        )
        concat_left_row_4 = torch.cat(
            [input_4_left_cnn_r4_c1, input_3_left_cnn_r4_c2, input_2_left_cnn_r4_c3],
            dim=1,
        )
        ...
        # Concatenate
        concat_right_row_2 = torch.cat(
            [input_2_right_cnn_r2_c1, input_1_right_cnn_r2_c2], dim=1
        )
        concat_right_row_3 = torch.cat(
            [input_3_right_cnn_r3_c1, input_2_right_cnn_r3_c2, input_1_right_cnn_r3_c3],
            dim=1,
        )
        concat_right_row_4 = torch.cat(
            [input_4_right_cnn_r4_c1, input_3_right_cnn_r4_c2, input_2_right_cnn_r4_c3],
            dim=1,
        )
        ...
        bfe_4_i1, bfe_4_i2, bfe_4_f_1_2, bfe_4_f_2_1 = self.flow_warp_r4(
            concat_left_row_4, concat_right_row_4, None, None
        )
        bfe_3_i1, bfe_3_i2, bfe_3_f_1_2, bfe_3_f_2_1 = self.flow_warp_r3(
            concat_left_row_3, concat_right_row_3, bfe_4_f_1_2, bfe_4_f_2_1
        )
        bfe_2_i1, bfe_2_i2, bfe_2_f_1_2, bfe_2_f_2_1 = self.flow_warp_r2(
            concat_left_row_2, concat_right_row_2, bfe_3_f_1_2, bfe_3_f_2_1
        )
        bfe_1_i1, bfe_1_i2, _, _ = self.flow_warp_r1(
            input_1_left_cnn_r1_c1, input_1_right_cnn_r1_c1, bfe_2_f_1_2, bfe_2_f_2_1
        )
        ...
        add_row_3 = (
            self.attention_r3(
                torch.cat([bfe_4_f_1_2, bfe_4_f_2_1], dim=1), bfe_3_i1 + bfe_3_i2
            )
            + upsample_row_4
        )
        ...
        add_row_2 = (
            self.attention_r2(
                torch.cat([bfe_3_f_1_2, bfe_3_f_2_1], dim=1), bfe_2_i1 + bfe_2_i2
            )
            + upsample_row_3
        )
        ...
        add_row_1 = (
            self.attention_r1(
                torch.cat([bfe_2_f_1_2, bfe_2_f_2_1], dim=1), bfe_1_i1 + bfe_1_i2
            )
            + upsample_row_2
        )
