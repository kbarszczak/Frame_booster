...
class FlowEstimation(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        for fcount, fsize, fstride, fpad, fact in zip(
            flow_info["filter_counts"],
            flow_info["filter_sizes"],
            flow_info["filter_strides"],
            flow_info["filter_padding"],
            flow_info["activations"],
        ):
...
class FBNet(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.cnn_r3_c3 = nn.Conv2d(
            encoder_filters[1][0], encoder_filters[2][0], 3, 1, 1
        )
        self.cnn_r4_c3 = nn.Conv2d(
        ...
        self.bidirectional_flow_warp_row_1 = BidirectionalFeatureWarp(
            flow_prediction=FlowEstimation(
                flow_input_chanels=2 * encoder_filters[0][0], flow_info=flow_info[0]
            ),
    ...
    def forward(self, input_1_left, input_1_right):
        ...
        # Feature extraction for layer 2
        input_1_right_cnn_r2_c2 = self.act_r2_c2(
            self.cnn_r2_c2(input_1_right_cnn_r2_c1)
        )
        input_2_right_cnn_r3_c2 = self.act_r3_c2(
            self.cnn_r3_c2(input_2_right_cnn_r3_c1)
        )
        input_3_right_cnn_r4_c2 = self.act_r4_c2(
            self.cnn_r4_c2(input_3_right_cnn_r4_c1)
        )
        ...
        # Feature extraction for layer 3
        input_1_right_cnn_r3_c3 = self.act_r3_c3(
            self.cnn_r3_c3(input_1_right_cnn_r3_c2)
        )
        input_2_right_cnn_r4_c3 = self.act_r4_c3(
            self.cnn_r4_c3(input_2_right_cnn_r4_c2)
        )
        ...
        bfe_4_i1, bfe_4_i2, bfe_4_f_1_2, bfe_4_f_2_1 = (
            self.bidirectional_flow_warp_row_3(
                concat_left_row_4, concat_right_row_4, None, None
            )
        )
        bfe_3_i1, bfe_3_i2, bfe_3_f_1_2, bfe_3_f_2_1 = (
            self.bidirectional_flow_warp_row_3(
                concat_left_row_3, concat_right_row_3, bfe_4_f_1_2, bfe_4_f_2_1
            )
        )
        bfe_2_i1, bfe_2_i2, bfe_2_f_1_2, bfe_2_f_2_1 = (
            self.bidirectional_flow_warp_row_2(
                concat_left_row_2, concat_right_row_2, bfe_3_f_1_2, bfe_3_f_2_1
            )
        )
        bfe_1_i1, bfe_1_i2, _, _ = self.bidirectional_flow_warp_row_1(
