...
class FBNet(nn.Module):
    def __init__(self, input_shape, device, filters=[32, 32, 32, 32], **kwargs):
        ...
        self.flow_warp_r1 = FlowFeatureWarp(input_channels=self.c + filters[0], level=1)
        self.flow_warp_r2 = FlowFeatureWarp(
            input_channels=self.c + filters[0] + filters[1], level=2
        )
        self.flow_warp_r3 = FlowFeatureWarp(
            input_channels=self.c + filters[0] + filters[1] + filters[2], level=3
        )
        ...
        self.conv_dec_block_r4 = Conv2dBlock(
            self.c + filters[0] + filters[1] + filters[2] + filters[3],
            self.c + filters[0] + filters[1] + filters[2],
            3,
            1,
            1,
        )
        ...
        self.conv_dec_block_r2 = Conv2dBlock(
            self.c + filters[0] + filters[1], self.c + filters[0], 3, 1, 1
        )
    ...
    def forward(self, left, right):
        ...
        # second conv block
        input_left_cnn_r2 = torch.cat(
            [self.cnn_block_r2(input_left_avg_r1), input_left_avg_r1], dim=1
        )
        input_left_avg_r2 = self.avg_r2(input_left_cnn_r2)

        # third conv block
        input_left_cnn_r3 = torch.cat(
            [self.cnn_block_r3(input_left_avg_r2), input_left_avg_r2], dim=1
        )
        input_left_avg_r3 = self.avg_r3(input_left_cnn_r3)

        # fourth conv block
        input_left_cnn_r4 = torch.cat(
            [self.cnn_block_r4(input_left_avg_r3), input_left_avg_r3], dim=1
        )
        ...
        # second conv block
        input_right_cnn_r2 = torch.cat(
            [self.cnn_block_r2(input_right_avg_r1), input_right_avg_r1], dim=1
        )
        input_right_avg_r2 = self.avg_r2(input_right_cnn_r2)

        # third conv block
        input_right_cnn_r3 = torch.cat(
            [self.cnn_block_r3(input_right_avg_r2), input_right_avg_r2], dim=1
        )
        input_right_avg_r3 = self.avg_r3(input_right_cnn_r3)

        # fourth conv block
        input_right_cnn_r4 = torch.cat(
            [self.cnn_block_r4(input_right_avg_r3), input_right_avg_r3], dim=1
        )
        ...
        # * input_right_cnn_r4
        # ------------- Warp features
        warp_left_r4, warp_right_r4, flow_1_2_r4, flow_2_1_r4 = self.flow_warp_r4(
            input_left_cnn_r4, input_right_cnn_r4, None, None
        )
        warp_left_r3, warp_right_r3, flow_1_2_r3, flow_2_1_r3 = self.flow_warp_r3(
            input_left_cnn_r3, input_right_cnn_r3, flow_1_2_r4, flow_2_1_r4
        )
        warp_left_r2, warp_right_r2, flow_1_2_r2, flow_2_1_r2 = self.flow_warp_r2(
            input_left_cnn_r2, input_right_cnn_r2, flow_1_2_r3, flow_2_1_r3
        )
        warp_left_r1, warp_right_r1, _, _ = self.flow_warp_r1(
            input_left_cnn_r1, input_right_cnn_r1, flow_1_2_r2, flow_2_1_r2
        )
