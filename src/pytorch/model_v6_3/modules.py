...
class FBNet(nn.Module):
    def __init__(self, input_shape, device, filters=[32, 32, 32, 32], **kwargs):
        ...
        self.conv_dec_block_r3 = Conv2dBlock(filters[2] + filters[3], filters[2], 3, 1, 1)
        self.up_r3 = nn.Upsample(scale_factor=(2, 2), mode='bilinear', align_corners=True)
        
        self.conv_dec_block_r2 = Conv2dBlock(filters[1] + filters[2], filters[1], 3, 1, 1)
        self.up_r2 = nn.Upsample(scale_factor=(2, 2), mode='bilinear', align_corners=True)
        
        self.conv_dec_block_r1 = Conv2dBlock(filters[0] + filters[1], filters[0], 3, 1, 1)
