...
class FBNet(nn.Module):
    def __init__(self, input_shape, device, filters=[64, 64, 64, 64], **kwargs):
        ...
        self.attention_r1 = AttentionGate(
            g_filters=filters[0], x_filters=filters[0], filters=filters[0]
        )
        self.attention_r2 = AttentionGate(
            g_filters=filters[1], x_filters=filters[1], filters=filters[1]
        )
        self.attention_r3 = AttentionGate(
            g_filters=filters[2], x_filters=filters[2], filters=filters[2]
        )
