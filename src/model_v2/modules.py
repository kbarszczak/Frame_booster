...
class FBNet(layers.Layer):
    ...
    def call(self, inputs, batch_size=1):
        ...
        bfe_4_i1, bfe_4_i2, bfe_4_f_1_2, bfe_4_f_2_1 = self.bidirectional_flow_estimation_3([feature_extraction_1[3], feature_extraction_2[3], empty_flow_1, empty_flow_2])
        bfe_3_i1, bfe_3_i2, bfe_3_f_1_2, bfe_3_f_2_1 = self.bidirectional_flow_estimation_3([feature_extraction_1[2], feature_extraction_2[2], bfe_4_f_1_2, bfe_4_f_2_1])
        bfe_2_i1, bfe_2_i2, bfe_2_f_1_2, bfe_2_f_2_1 = self.bidirectional_flow_estimation_2([feature_extraction_1[1], feature_extraction_2[1], bfe_3_f_1_2, bfe_3_f_2_1])
        bfe_1_i1, bfe_1_i2, _, _ = self.bidirectional_flow_estimation_1([feature_extraction_1[0], feature_extraction_2[0], bfe_2_f_1_2, bfe_2_f_2_1])
